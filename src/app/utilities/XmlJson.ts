export class XmlJsom{
    /**
     * Remove html tags from code
     * @param html string with original HTML code
    ...
    /**
     * It transform xml to json format
     * @param text xml
     * @param tab character to replace /t in json
     * @returns json
     */
    public static xml2json(text:string, tab:string):string {
         ...
         if (xml.nodeType == 9)
           // document node
           xml = xml.documentElement as any;
